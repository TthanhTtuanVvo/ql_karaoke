<h1 style="display: none;">Tin tức - Mercury</h1>
<h3 style="display: none;">các tin tức - Mercury</h3>
<div class="block-main">
                ...
                <div <?if($dem%2==1){ echo 'class="box-news col-sm-12 wow slideInLeft"';} else { echo 'class="box-news col-sm-12 wow slideInRight"';}?> data-wow-duration="1s" data-wow-delay=".2s">
                    <div class="row">
                        <div class="box-new-img col-sm-4 col-xs-5">
                            <a href="<?=$domain?>tin-tuc-xem/<?=$row['id']?>-<?=lg_string::get_link($row['ten'])?>.html"><img class="img-responsive" src="<?=$domain?>uploads/cms/news_<?=$row['hinh']?>" alt="<?=$row['ten']?>"></a>
                        </div>
                        <div class="box-new-content col-sm-8 col-xs-7">
                            <div class="news-title">
                                <p><a href="<?=$domain?>tin-tuc-xem/<?=$row['id']?>-<?=lg_string::get_link($row['ten'])?>.html" title=""><?=$row['ten']?></a></p>
                            ...
                            <span class="read-more">
                                <a href="<?=$domain?>tin-tuc-xem/<?=$row['id']?>-<?=lg_string::get_link($row['ten'])?>.html" title="<?=$row['ten']?>">Xem thêm <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                            </span>
        ...
        <? showPageNavigation($page, $pages, $domain.'tin-tuc/'); ?>
    </div>