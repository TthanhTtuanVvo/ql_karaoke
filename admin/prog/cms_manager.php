					...
					<tbody>
						<?php
							...
							?>
							  <tr class="tb_content">
							    <td>&nbsp;</td>
							    <td style="text-align:left;"><img src="images/node.gif" align="absmiddle" /> <img src="images/lang_vn.gif" align="absmiddle" /> <a class="a_sp" href="?act=cms_list&id=<?=$row2["id"]?>"><?=$row2["ten"]?></a> <font size=1 color="#999999"><?=$row2["type"]==0?"1 column":($row2["type"]==1?"2 columns":"1 page")?></font></td>
							    ...
							    <td align="center"><a href="?act=cms_list&id=<?=$row2["id"]?>" class="icon-form"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
							  </tr>
							<?php
								}
							}
