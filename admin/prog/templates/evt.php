...
<div class="page-title">
  <div>
    <h1><i class="fa fa-edit"></i> <?=($_GET['act'] == "evt_new") ? "Quản lý thêm bài viết" : "Quản lý sửa bài viết"?></h1>
    <p></p>
  </div>
  <div>
    <ul class="breadcrumb">
      ...
      <li><a href="?act=evt_new&id=<?=$_GET['id']?>"><?=($_GET['act'] == "evt_new") ? "thêm bài viết" : "sửa bài viết"?></a></li>
    </ul>
  </div>
</div>
<?
function	template_edit($url,$func,$id,$txt_cat,$txt_ten,$txt_time,$txt_chu_thich,$txt_hinh,$txt_hinh_note,$txt_noi_dung,$txt_hien_thi,$txt_noi_bat,$txt_date,$error,$txt_title,$txt_keyword,$txt_description)
{
global $db, $domain;
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="form-group">
			...
			<input type="button" class="btn btn-default" name="submit" value="Xem danh sách" onclick="Forward('?act=evt_list&id=<?=$txt_cat?>');"/>
		</div>
		<div role="tabpanel">
			<!-- Nav tabs -->
						    ...
						    <div class="card">
						      <div class="card-body">
							    ...
							    <div class="form-group">
							            ...
							            <div class="col-md-8">
							            	<input type="date" name="txt_time" value="<?=$txt_time?>" class="form-control">
							            </div>
							            <div class="clearfix"></div>
							    </div>
						        <div class="form-group">
							        ...
							        <div class="form-group">
							            ...
							            <div class="col-md-8">
							            	<input type="file" name="txt_hinh" value="" class="form-control">
							           		...
							           		<?if($func=='update'){?>
							           		<img src="<?=$domain?>/uploads/evt/news_<?=$img_name?>" class="img-responsive" />
							           		<?}?>
							            </div>
							            <div class="clearfix"></div>
							        </div>
