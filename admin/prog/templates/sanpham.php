<?
// // if($_GET['act']=='sanpham_new')
// {
//    $cat_name = get_sql("select ten from tgp_product_menu where id=".$txt_cat);
// }
// else
// {
//    $cat_id = get_sql("select cat from sanpham where id=".$id);
...
<div class="page-title">
   <div>
      <h1><i class="fa fa-edit"></i> <?=($_GET['act'] == "sanpham_new") ? "Quản lý thêm phòng" : "Quản lý sửa phòng"?></h1>
      <p></p>
   </div>
   <div>
      <ul class="breadcrumb">
...
<? 
   ...
   function template_edit($url,$func,$id,$txt_cat,$txt_ten,$txt_chu_thich,$txt_noi_dung,$txt_hien_thi,$txt_noi_bat, $txt_title, $txt_keyword, $txt_description,$error)
   {
       global $db;
       $thumbnailname = get_sql("select hinh from sanpham where id= '".$id."'"); 
   ...
   <div class="col-md-12">
      ...
      <form name="frm_edit" id="frm_edit" action="<?=$url?>" enctype="multipart/form-data" method="post" style="margin:0px;" />
         ...
         <div class="form-group">
            ...
            <input type="button" class="btn btn-default" name="submit" value="Xem danh sách" onclick="Forward('?act=sanpham_list&id=<?=$txt_cat?>');"/>
         </div>
                           ...
                           <div class="card-body">
                              ...
                              <!-- <div class="col-xs-12 form-group">
                                 <div class="col-xs-12">
                                    ...
                                    <div class="col-md-8">
                                       <textarea rows="3" name="txt_chu_thich" class="form-control"><?=$txt_chu_thich?></textarea>
                              ...
                              <div class="col-xs-12 form-group">
                                 <div class="col-xs-12">
                                    ...
                                    <div class="col-md-9">
                                       ...
                                       <span>Kích thước chuẩn 800x800 px</span>
                                    </div>
                                    <div class="clearfix"></div>
                                 </div>
                                 <?if($func=='update'){?>
                                 <div class="col-xs-12">
                                    ...
                                    <div class="col-md-8">
                                       <img src="../uploads/product/sp_<?=$thumbnailname?>" style="width:160px"/>
                                    </div>
                                    <div class="clearfix"></div>
                                 </div>
                                 <?}?>                                      
